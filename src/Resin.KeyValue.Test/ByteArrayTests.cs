namespace Resin.KeyValue.Test
{
    ...
    public sealed class ByteArrayTests
    {
        ...
        public void CanThrowOutOfPageStorageException()
        {
            ...
            {
                var writer = new ByteArrayWriter(valueStream, pageSize * sizeof(long));
        ...
        public void CanReadWritePages()
        {
            ...
            const int pageSize = 4096; // 4096 bytes
            ...
            {
                var testCases = new List<long>();
                var writer = new ByteArrayWriter(valueStream, pageSize: pageSize * sizeof(long));
                for (int i = 0; i < testCount; i++)
                {
                    try
                    {
